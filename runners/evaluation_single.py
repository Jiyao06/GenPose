...
def record_results_and_draw_curves(save_path, iou_aps, pose_aps, iou_acc, pose_acc, iou_thres_list, degree_thres_list, shift_thres_list):
    ...
    for i in range(1, 8, 1):
        ...
        messages.append('mAP:')
        # messages.append('2D IoU at 25: {:.1f}'.format(iou_aps[i, iou_25_idx] * 100))
        # messages.append('2D IoU at 50: {:.1f}'.format(iou_aps[i, iou_50_idx] * 100))
        # messages.append('2D IoU at 75: {:.1f}'.format(iou_aps[i, iou_75_idx] * 100))
        ...
        messages.append('Acc:')
        # messages.append('2D IoU at 25: {:.1f}'.format(iou_acc[i, iou_25_idx] * 100))
        # messages.append('2D IoU at 50: {:.1f}'.format(iou_acc[i, iou_50_idx] * 100))
        # messages.append('2D IoU at 75: {:.1f}'.format(iou_acc[i, iou_75_idx] * 100))
